            ...
            <form action="{{ route('clientes.update',['cliente'=>$cliente]) }}" method="post">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="numero_celular" id="numero_celular" class="form-control" value="{{old('numero_celular',$cliente->persona->numero_celular)}}">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="correo" id="correo" class="form-control" value="{{old('correo',$cliente->persona->correo)}}">
                        @error('correo')
                        <small class="text-danger">{{'*'.$message}}</small>
                    @enderror
                    </div>
