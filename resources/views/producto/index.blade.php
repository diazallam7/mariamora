                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Mas Informacion
                                                </h1>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-3">
                                                    <label for=""><span
                                                            class="fw-bolder">Direccion:</span> {{$item->descripcion}}</label>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for=""><span
                                                            class="fw-bolder">Telefono:</span> {{$item->numero_celular}}</label>
                                                </div>
                                            </div>
